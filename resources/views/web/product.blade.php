...
<main class="product-view">
    <div class="product-view__gallery">
        <a href="{{ route('web.categories') }}" class="block mt-3">Powrót</a>
        <h3>{{ $product->name }}</h3>
        <div class="loader">
            <img class="loader__icon" src="{{ asset('/assets/images/brand/logo_icon.png')}}" />
            <p class="loading">Ładowanie przedmiotu</p>
        </div>
        <div class="container">
    ...
    <div class="product-view__content">
        <div class="product-view__date">
            <span>Ogłoszenie dodane {{ \Carbon\Carbon::parse($product->created_at)->format('d.m.Y') }}</span>
        </div>
        ...
        <div class="product-view__details">
            ...
            <span class="product-view__details__date">Użytkownik od
        ...
        <a href="{{ route('web.categories') }}" class="product-view__others">
            <span>Pozostałe przedmioty</span>
        </a>

        <form class="product-view__reservation" action="">
            <h4>Rezerwacja przedmiotu</h4>
            <div>	
                <label>Od</label>		
            ...
            <button type="submit" class="product-view__reservation__submit">Złóż ofertę rezerwacji</button>
        </form>

        <div class="product-view__map__title">Zobacz jak do nas dojechać</div>
