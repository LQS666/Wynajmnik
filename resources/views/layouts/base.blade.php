                ...
                <nav class="flex w-full fixed z-50 items-center justify-between bg-white py-6 px-12 shadow-lg">
                    ...
                    <div class="flex items-center w-auto">
                        <div class="text-sm flex-grow">
                            <a href="#" class="inline-block mt-0 mr-8 text-purple-second hover:text-indigo-700 transition">{{ __('base.offers') }}</a>
                        </div>
                        <div class="text-sm flex-grow">
                            <a href="#" class="inline-block mt-0 mr-8 text-purple-second hover:text-indigo-700 transition">{{ __('base.map') }}</a>
                        </div>
                        @guest
                        <div class="text-sm flex-grow">
